...
(function () {
  ...
  // as its X-axis (playing-time for the pairing, idle gaps collapsed); the window is still
  // the week's first/last kickoff for anything that needs the slate itself.
