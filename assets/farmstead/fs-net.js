...
(function () {
  ...
  function warn(err) { if (window.console && console.warn) console.warn("Castle Kruzer net:", err); }
  ...
  FSNet.host = function (opts) {
    ...
    const settings = {
      ...
      difficulty: opts.difficulty,   // AI skill is world state: the host decides for both seats
      mode: mode,
  ...
  function lobbyEnsure(o) {
    ...
    return lobbyReady().then(function () {
      ...
      return fs.setDoc(LOBBY.ref, {
        game: "farmstead", gameName: "Castle Kruzer", ico: "🏰",
