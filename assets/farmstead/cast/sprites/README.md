...
Generated by `node tools/_fs_bake_sprites.cjs` on 2026-08-02T19:24:39Z.
Source model: **minifig** (the procedural minifig from the pre-cast
...
|---|---|---|---|
| `serf-body.png` | 2048x3968 | 1598.6 KB | colour |
| `serf-mask.png` | 1024x1984 | 138.5 KB | mask (R=team, G=rank) |
| `knight-body.png` | 2048x1920 | 864.3 KB | colour |
| `knight-mask.png` | 2048x1920 | 249.5 KB | mask (R=team, G=rank) |
| `overlays.png` | 1536x3904 | 358.6 KB | overlay |
...
158 of 1456 overlay cells come out fully hidden
