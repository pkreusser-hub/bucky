...
Generated by `node tools/_fs_bake_sprites.cjs --source dwarfknight` on 2026-08-02T22:55:13Z.
...
|---|---|---|---|
| `serf-body.png` | 2048x3968 | 2523.2 KB | colour |
| `serf-mask.png` | 1024x1984 | 131.2 KB | mask (R=team, G=rank) |
...
`manifest.json` ships minified — the anchor tables run to ~4416 entries.
