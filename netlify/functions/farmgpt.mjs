...
// THE POWER RANKINGS ANALYST (2026-09-08, grok-4.6, mode `gfflpower`) was RETIRED 2026-09-23:
// the GFFL power rankings are now computed in the app from its own projections, scores and
// schedule (assets/league/lg-core.js, LG.powerWeekBoard / LG.powerRosBoard). No AI at all.
...
// The gffl modes (fantasy/ffrecap/ffcommentary/gfflproj/gffltrade/gffladjust) were gated on
...
// gfflpower joined 2026-09-08 and left 2026-09-23 (power rankings are computed in the app now).
