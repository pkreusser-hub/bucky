...
(function () {
  ...
  /** closed polygon: forward down the left offsets, back up the right ones */
  function ribbonPath(g, s, nor, wL, wR) {
    ...
    R.reverse();
    g.beginPath();
    traceSmooth(g, L, true);
    traceSmooth(g, R, false);
    g.closePath();
  }
  ...
  function paintRoadStroke(g, st) {
    ...
    for (let i = 0; i < grit; i++) {
      ...
      g.fillStyle = rnd() < 0.5 ? "rgba(" + ROADPAINT.RUT + ",0.20)" : "rgba(236,224,196,0.20)";
      g.beginPath();
